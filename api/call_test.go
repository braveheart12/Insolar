...
func TestTimeoutSuite(t *testing.T) {
	...
	cr.SendRequestWithPulseFunc = func(p context.Context, p1 *insolar.Reference, method string, p3 []interface{}, p4 insolar.PulseNumber, se *error) (insolar.Reply, error) {
		switch method {
		case "GetPublicKey":
